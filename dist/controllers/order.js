  ...
  _createClass(Order, null, [{
    ...
    value: function () {
      ...
      regeneratorRuntime.mark(function _callee(req, res) {
        var _req$body, buyer_id, price_offered, created_on, _ref, rows, validateOrder, owner_id, amount, values, createdOrder;
        ...
        return regeneratorRuntime.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                _context.prev = 0;
                _req$body = req.body, buyer_id = _req$body.buyer_id, price_offered = _req$body.price_offered;
